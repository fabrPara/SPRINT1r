...
class QuoridorGame:
    ...
    def __init__(self):
        ...
        # crea i giocatori
        p1_start = Cell(4, 0)  # posizione iniziale del giocatore 1
        p2_start = Cell(4, 8)  # posizione iniziale del giocatore 2
        p1 = [Player(player_id=1, start_pos=p1_start, target_row=8)]
        p2 = [Player(player_id=2, start_pos=p2_start, target_row=0)]
        self._players = [p1, p2]

        self._current_turn = 0  ##indice del giocatore che deve muovere (1 o 2)
        self._winner = None
