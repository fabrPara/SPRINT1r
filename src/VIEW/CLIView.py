...
[bold green]move <cella>[/bold green]         Muovi il pedone. Es: move e5

[bold green]wall <cella><dir>[/bold green]    Piazza un muro.
                     Es: wall e5h (orizzontale)
                     Es: wall e5v (verticale)
